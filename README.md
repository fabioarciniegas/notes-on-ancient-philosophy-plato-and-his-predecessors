...
Four key BC ranges to keep in mind:
 - Presocratics(625-500)
 - Socrates(470-399)
 - Plato (430-347)
 - Aristotle (384-323)
 ...
 *Note*: References to the milesians writings are made according to
 ...
 philosopher has numbered entries. Whence Heraclitus B50 indicates
 50th fragment in DK. Furthermore, each philosopher has a number
 whence refs such as DK11A9 (Aristotle, testimonia 9) 

Aristotle calls the Milesians the first philosophers. They are
commonly concerned with identifying the internal innermost constituent
...
Studied here in the following pairing of books to main concerns:
 ...
 - The Meno: Epistemology: can virtue be thaught? what can be taught?
...
The dialog, as usual in socratic dialogs is characterized by its format, named Elenchus (or Maieutic method) which is the socratic form of questioning rather than lecturing.  Socrates invites to "recall together" in a form of enquiry rather than "teaching."

When Socrates says that he doesn't know what Virtue is and asks Meno what Virtue he means, Meno can only give examples of virtuous things. This gives rise to the objection or worry that the Elenchus can only be negative and never produce solid positive knowledge. Socrates defends it with the famous geometry lesson:

Socrates brings a slave and starts asking him about a 1 square meter area and then asks him to construct one that is twice as large. The slave stumbles and guided by socrates finally arrives at the idea that taking the diagonal of the original square as the side for the second square is the right answer.
...
How can you start enquiring about anything if you cannot define it and how can you define it if you don't enquire about it?

Socrates answer is you only need true beliefs to enquire, not knowledge. Knowledge is stronger than true beliefs. You can believe the right thing for the wrong reasons.

Knowlege differs from true beliefs in the method by which it is
acquired, it is more stable. You can believe something false but you
cannot _know_ something false.

e.g. you may believe 317 is a prime number for the wrong reasons, say
...
Socrates starts by making  Thrasymachus  admit that a just man is
actually happy. The argument of the republic II-IV justice will always
be better even if unnoticed or unrewarded by gods or citizens.

The structure of the argument is roughly as follows: a city (Polis)
which exists for the skae of making it easier to provide for our
needs, has 3 jobs/parts: the Rulers, Auxiliaries (military), and
Producers (merchants).
...
made of Reason, Spirit, and Appetite.

In a well-functioning psyche the reason rules, the spirit is aligned
with the rulings of reason and not in opposition to them and the
appetites are measuredly fed and put to productive use.

The soul of the unjust is at civil war.

For example the money-grabbing man has enslaved the intellect to
appetite so his spirit cannot discern what the use of it is or what to
praise but it.

Justice is desirable on its own (not for reward) in the very special
...
The principle of charity requires interpreting a speaker's statements
to be rational and, in the case of any argument, considering its best,
...
justice. The main observation is that there is one thing that IS
courage and MANY things that are corageous. This difference between the
One and the many is essential to the plato's thoughts on this topic.
...
suggests further dividing the lower half between the mere
...
The most important point is the notion of pure reason, unmediated by
...
Socrates being focused on the higher principles and sources (as
opposed to Aristotle) as portrayed by Raphael in his painting comes
from the Timeaus.

In the Timeaus Socrates talks about a likely story, an eikos logos,
where the Demiurge brings order in the primordial soup by copying from
the forms into the physical world.

From Model (Reason) the demiurge takes image and put it on a
...
life and propends towards the highest good, the highest reason. In
this sense the world posesses a Mathematical soul.

The elements by which Socrates explains these are arithmetic means and
not explained in these notes. Also mentioned in the timeaus but not
explained here are perfect triangles and the derivation of the five
platonic solids: teta, hexa, octa, dodeca, icosa.
